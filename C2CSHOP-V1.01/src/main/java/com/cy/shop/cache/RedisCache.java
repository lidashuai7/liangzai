...
import com.cy.shop.config.ApplicationContextHolder;
...
//        return opsForValue.get(key);
    ...
    private RedisTemplate getRedisTemplate() {
        if (redisTemplate == null) {
            redisTemplate = (RedisTemplate) ApplicationContextHolder.getContext().getBean("redisTemplate");
        }
